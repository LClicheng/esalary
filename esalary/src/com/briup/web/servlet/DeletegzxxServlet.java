...
/**
 * Servlet implementation class DeletegzxxServlet
 */
@WebServlet("/deletegzxx.do")
public class DeletegzxxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeletegzxxServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("deletesalary.jsp");
	}
